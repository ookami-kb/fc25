...
abstract class ChatServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$0.WatchMessagesResponse> watchMessages(
      $pb.ServerContext ctx, $0.WatchMessagesRequest request);
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx,
    ...
    switch (methodName) {
      ...
      case 'WatchMessages':
        return watchMessages(ctx, request as $0.WatchMessagesRequest);
      default:
        throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
